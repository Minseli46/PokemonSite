...
import { QuizBuilderInterface } from '@/components/ai/quiz-builder-interface'
...
export default function QuizPage() {
  ...
  const handleQuizGenerated = useCallback((questions: QuizQuestionAction[]) => {
    if (questions.length > 0) {
      setAiQuestions(questions.map(q => q.data))
      setAiAnswers({})
      setAiScore(0)
      setShowAiHints({})
    }
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto mb-8">
          <QuizBuilderInterface onQuizGenerated={handleQuizGenerated} />
        </div>

        {/* AI-Generated Quiz Questions — Displayed Right Below Generator */}
          ...
          >
            ...
            {Object.keys(aiAnswers).length === aiQuestions.length && aiQuestions.length > 0 && (
              <motion.div
                ...
                className="bg-card border border-border rounded-xl p-6 text-center space-y-4 mt-6"
              >
        ...
        {/* Traditional Quiz Game (Optional) */}
